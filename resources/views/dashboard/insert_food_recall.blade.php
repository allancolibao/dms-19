            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="card">
                        ...
                        <div class="content"> 
                                <form class="insert_form" method="post" action="{{action('FoodRecordController@insertRecall')}}">
                                   {{csrf_field()}} 
                                   ...
                                   <div class="row">
                                       <div class="col-md-2">
                                           <div class="form-group">
                                               <label>Line no.</label>
                                           <input type="text" class="form-control" name="LINENO" id="LINENO" placeholder="Line no" value=""/>
                                           </div>
                                       </div>
                                       <div class="col-md-4">
                                           <div class="form-group">
