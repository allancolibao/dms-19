...
<div class="content">
    <div class="container-fluid">
        ...
        <button data-path={{ route('insert.record', ['eacode'=>$eacode, 'hcn'=>$hcn, 'shsn'=>$shsn])}} type="button" style="background: #183ace;" class="d-sm-inline-block btn  btn-secondary shadow-sm open-modal">
            Insert Food Record
        </button>
        <hr>        
                                        ...
                                        <div>
                                            ...
                                            <table class="table table-hover table-striped">
                                                ...
                                                <tbody>
                                                    ...
                                                    <form class="update_form" method="post" action="{{ route('update.food-record', $record->id)}}">
                                                    {{csrf_field()}}
                                                    <input type="hidden" name="id[]" value="{{$record->id}}" />
                                                    <tr>
                                                        <td>
                                                            <input type="number" style="any" class="form-control" name="LINENO[]" id="LINENO" placeholder="Line no" value="{{$record->LINENO}}"/>
                                                        </td>
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="header">
                                <h4 class="title">Form 6.3 - Household Food Record</h4>
                                <p class="category"></p>
                                <h5 class="alert alert-warning">No food record found in this household</h5><br>
                            </div>  
                        </div>
                    </div> 
                @endif
