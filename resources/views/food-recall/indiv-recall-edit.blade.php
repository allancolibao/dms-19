...
<div class="content">
    <div class="container-fluid">
        ...
        <a href="{{ route('indiv.recall', ['eacode'=>$eacode, 'hcn'=>$hcn, 'shsn'=>$shsn, 'MEMBER_CODE'=>$member, 'GIVENNAME'=>$givenname, 'SURNAME'=>$surname, 'AGE'=>$age])}}">
            <button type="submit" class="btn btn-secondary" style="background:#e61a2b;">
                <i class="pe-7s-back"></i> Go back
            </button>
        </a>

        <button data-path={{ route('indiv.insert-recall', ['eacode'=>$eacode, 'hcn'=>$hcn, 'shsn'=>$shsn, 'MEMBER_CODE'=>$member, 'GIVENNAME'=>$givenname, 'SURNAME'=>$surname, 'AGE'=>$age, 'recday'=>$recday])}} type="button" style="background: #183ace;" class="d-sm-inline-block btn  btn-secondary shadow-sm open-modal">
            Insert Food Recall
        </button>
        <hr>
                        ...
                        <div class="content table-responsive table-full-width">
                            ...
                            <table class="table">
                                ...
                                <tbody>
                                        @foreach ($l1 as $value)
                                    <tr>
                                        <form class="update_form" method="post" action="{{ route('update.ref', $value->id)}}">
                                        {{csrf_field()}}
                                        <td>
                                            <div class="row">
                                                <div class="col-md-4">
                        ...
                        <div class="table-responsive-foodrecall">
                            ...
                            <div class="content table-full-width">
                                    <table class="table table-hover table-striped">
                                        ...
                                        <form class="update_form" method="post" action="{{ route('update.recall', $value->id)}}">
                                        {{csrf_field()}}
                                        <tbody>
                                            ...
                                            <input type="hidden" name="id[]" value="{{$value->id}}" />
                                                ...
                                                <td>
                                                    <input type="number" style="any" class="form-control" name="LINENO[]" placeholder="Line no" value="{{$value->LINENO}}"/>
                                                </td>
                                                <td>
                                ...
                                @else
                                    <h5 class="alert alert-warning">No food recall day {{$recday}}</h5><hr>
                                    @endif
                                @endif
                            </div>
                        </div>
